...
const COURSE_API = "https://avishkar-1-server-2.onrender.com/api/v1/course";

export const courseApi = createApi({
  reducerPath: "courseApi",
  tagTypes: ["Refetch_Creator_Course", "Refetch_Lecture", "Published_Courses", "RequestStatus"],
  baseQuery: fetchBaseQuery({
    baseUrl: "https://avishkar-1-server-2.onrender.com",  // Empty baseUrl as we'll use absolute paths
    credentials: "include",
